...
use crate::{
    ...
    types::{LoggingObserver, Memory, NoOpObserver, ObserverType, Stack, StatsObserver},
    u256,
};
...
impl EvmcVm for EvmRs {
    fn init() -> Self {
        EvmRs {
            observer_type: ObserverType::Stats,
        }
    }
    ...
    fn execute<'a>(
        ...
        match self.observer_type {
            ...
            ObserverType::Stats => interpreter.run(&mut StatsObserver::new(std::io::stdout())),
        }
    }
